  ...
  // console.log(id);
    ...
    return (
      <div className=" w-full text-white py-20 bg-gray-800 lg:h-screen xl:h-screen">
           ...
           <div className="sm:flex content-center justify-center">
               <div className=" sm:w-2/4 w-3/4 mx-auto h-auto my-6 lg:mx-8 md:mx-4 text-center">
                   <button className=" text-lg text-justify mx-4  bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-full" onClick={goBackHandler}>Go back</button>
               </div>
           </div>
      </div>
    )
